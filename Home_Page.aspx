<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Home_Page.aspx.cs" Inherits="First_Web_App.WebForm1" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div>
           <p id="welcome"> Welcome <asp:Label ID="tranName" runat="server" Text="name"></asp:Label></p>
        </div>
    </form>
